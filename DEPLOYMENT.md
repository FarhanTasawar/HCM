...
- The public URL from Render is the permanent link your users can open.
- That link does not change each time the app restarts, so it can be shared across devices.
